...
const instructionObj = {
    ...
    while strictly following the report template provided.
    Make sure to retain the chronological order of the paragraphs specific to different parts of the knee, in the "Findings" section.
